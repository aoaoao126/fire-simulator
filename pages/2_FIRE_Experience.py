...
with st.sidebar:
    ...
    with st.expander("🏛️ 歴史ガイド: 暴落に備える"):
        st.markdown("""
        S&P 500の過去約100年のデータでは、以下のような頻度で「嵐」が起きています。

        - **-10%以上の調整（ほぼ毎年）**: 約1年に1回発生。数ヶ月で回復することが多い。
        - **-20%以上の暴落（約6年に1回）**: 「弱気相場」の入り口。回復まで平均2年強。
        - **-30%以上の大暴落（約12年に1回）**: リーマン級。回復に3〜5年を要することも。

        **💡 3年ルール**  
        歴史上、多くの暴落は**3年以内**に回復しています。このシミュレーターでも**3年分の生活費（1,500万円）**を現金で持っておくことで、暴落中の安値売りを回避し、完走率を劇的に高めることができます。
        """)
